...
def trip_duration_stats(df):
    ...
    print("total_trips_time: {} hours".format(round((total_trips_time/60)/60, 1)))
...
def user_stats(df):
    ...
    print ("There are {} Subscribers".format(user_types_counts["Subscriber"]))
    print ("There are {} Customers".format(user_types_counts["Customer"]))
    
    # Display counts of gender
    print ("\nUser Gender Counts :\n")
    user_gender_counts= df["Gender"].value_counts()
    print ("There are {} Males".format(user_gender_counts["Male"]))
    print ("There are {} Females".format(user_gender_counts["Female"]))
